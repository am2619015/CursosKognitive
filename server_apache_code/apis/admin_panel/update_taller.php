<?php
    ...
    if(strcmp($mensaje_de,"correcto") == 0){
        ...
        $id_update=BlockSQLInjection(strip_tags(trim($id_update)));
    ...
    try{
        if($nombre_taller != ''){
            ...
            //INSERT INTO talleres(id_curso,nombre_taller,descripcion,video_1,video_2,video_3,video_4,material_taller,id_cuestionario,last_taller) VALUES(:idcur,:nt,:dt,:v1,:v2,:v3,:v4,:mt,:idcues,:la)

            $stm = $conn->prepare("UPDATE talleres SET id_curso=:idcur,nombre_taller=:nt,descripcion=:dt,video_1=:v1,video_2=:v2,video_3=:v3,video_4=:v4,material_taller=:mt,id_cuestionario=:idcues,last_taller=:la WHERE id_taller=:idup"); // funcion mysql con todos los datos
            ...
            $stm->bindValue(':idup', $id_update,PDO::PARAM_INT);
