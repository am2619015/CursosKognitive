<?php
    ...
    $stm = $conn->prepare("CALL fecha_caducidad_curso(:correo,:id_curso);"); // funcion mysql con todos los datos
    
    /* 
      CREATE DEFINER=`user_name_test`@`127.0.0.1` PROCEDURE `fecha_caducidad_curso`(
      IN emai_buscar VARCHAR(60),
      IN id_curso_buscar VARCHAR(60)
      )
      BEGIN
...
END
    */
        ...
        $stm->bindValue(":id_curso", $id_curso_user);
		$stm->execute();
