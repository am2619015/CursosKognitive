<?php
    ...
    $id_taller=$data['user_login2']["taller_id"];
    ...
    $stm = $conn->prepare("CALL get_info_construir_traller(:email,:id_curso,:id_taller);"); // funcion mysql con todos los datos
    ...
    /* 
            ...
            CREATE DEFINER=`user_name_test`@`127.0.0.1` PROCEDURE `get_info_construir_traller`(
