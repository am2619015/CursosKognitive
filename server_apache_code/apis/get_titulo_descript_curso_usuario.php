<?php
    ...
    $stm = $conn->prepare("CALL get_titulo_descripcion_curso_usuario(:email,:id);"); // funcion mysql con todos los datos
    ...
    /* 
            ...
            CREATE DEFINER=`user_name_test`@`127.0.0.1` PROCEDURE `get_titulo_descripcion_curso_usuario`(
