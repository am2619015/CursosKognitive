...
import {MDBBtn,MDBInput,MDBCol,MDBProgress,MDBAlert,MDBPopover,MDBIcon,MDBPopoverBody} from "mdbreact";
import axios from 'axios';

class crear_taller extends Base {
    ...
    handle_creating_taller = () =>{
        ...
        function process_resolving(){
            ...
            for (let i = 1; i <= thisClass.state.select_num_videos; i++) {
                //thisClass.showMsg("valor de "+this.state["video_data_"+i])
                if(thisClass.state["video_data_"+i] === undefined || thisClass.state["video_data_"+i]===null){
                    ...
                    //thisClass.showMsg("-------------------tamaño de archivo valido = "+thisClass.validate_size_file(thisClass.state["video_data_"+i],25));
            ...
            if(!validado_correctamente){
                ...
                axios.post(`${thisClass.get_ip_server()}/apis/admin_panel/upload_taller.php`, formData ,
                {
                    headers: {
                        'Content-Type': 'multipart/form-data'
                                                            ...
                                                            if(res.data.mensaje==="incorrecto"){
                                                                ...
                                                                thisClass.props.success_function(true,"Taller Creado","Taller y sus archivos subidos con exito");
                                                            }
    ...
    render = () =>{
        ...
        function inputs_videos(){
            ...
            for (let i = 1; i <= select_num_videos; i++) {
                inp_videos.push(<div key={i} className="input-group mt-2">
        ...
        this.state.loading_crear_taller
            ...
            :
                <div className={`mt-5 ${this.state.accion_creating_user?"no_interaction_taller":""}`}>
                    <form>
                        <div className="grey-text">
                                ...
                                <div className="custom-control custom-checkbox text-center mt-4 mb-4">
                                    <input type="checkbox" className="custom-control-input" id="defaultUnchecked_3" name="sobrescribirfiles" 
                                    onChange={e => this.handleChange_checkbox(e,"sobrescribirfiles")}
                                    checked={thisClass.state.sobrescribirfiles}
                                    />
                                    <label className="custom-control-label" htmlFor="defaultUnchecked_3">Sobrescribir archivos en server </label>
                                ...
                                <div className="custom-control custom-checkbox text-center mt-4">
                                    <input type="checkbox" className="custom-control-input" id="defaultUnchecked" name="material_didactico" 
                                    onChange={e => this.handleChange_checkbox(e,"material_didactico")}
                                    checked={thisClass.state.material_didactico}
                                    />
                                    <label className="custom-control-label" htmlFor="defaultUnchecked">Taller tiene material didactico</label>
                                </div>
                                ...
                                <div className="custom-control custom-checkbox text-center mt-4 mb-4">
                                    <input type="checkbox" className="custom-control-input" id="defaultUnchecked_2" name="taller_3_intentos" 
                                    onChange={e => this.handleChange_checkbox(e,"taller_3_intentos")}
                                    checked={thisClass.state.taller_3_intentos}
                                    />
                                    <label className="custom-control-label" htmlFor="defaultUnchecked_2">Es un taller de solo 3 intentos</label>
                                </div>
                        ...
                        {this.state.showing_msg_carga_minutos
                            ...
                            <MDBBtn type="button" className={this.state.accion_creating_user ? "disabled" : ""} onClick={this.handle_creating_taller}>Crear Taller</MDBBtn>
                            {this.state.accion_creating_user
                            ?
